...
export const TabBase = (_a) => {
    ...
    const WIDTH = React.Children.count(children) > 2
        ? dim.width / 3
        : dim.width / React.Children.count(children);
    return (<View>
      <ScrollView contentContainerStyle={{}} horizontal showsHorizontalScrollIndicator={false} scrollEnabled={React.Children.count(children) > 3} {...props} accessibilityRole="tablist" style={[
        styles.viewStyle,
        ...
        styles.indicator,
        {
            backgroundColor: (_b = theme === null || theme === void 0 ? void 0 : theme.colors) === null || _b === void 0 ? void 0 : _b.secondary,
            transform: [
                {
