...
export const LinearProgress = (_a) => {
    var _b, _c;
    var { value, variant = value === undefined ? 'indeterminate' : 'determinate', color = 'secondary', style, theme, trackColor, animation = { duration: 2000 } } = _a, props = __rest(_a, ["value", "variant", "color", "style", "theme", "trackColor", "animation"]);
    ...
    return (<View testID="STAR__LinearProgress_Bar" accessible accessibilityRole="progressbar" accessibilityValue={{
        now: clamp(value || 0),
        min: 0,
        max: 1,
    }} {...props} onLayout={e => {
      ...
      {animation ? (<Animated.View testID="STAR__LinearProgress_Progress" 
    // eslint-disable-next-line react-native/no-inline-styles
    style={{
        transform: [
            {
        ...
        flex: 1,
    }}/>) : (<View testID="STAR__LinearProgress_Progress" 
    // eslint-disable-next-line react-native/no-inline-styles
    style={{
        flex: 1,
