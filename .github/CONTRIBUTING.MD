...
If you would like to submit a feature request or report a bug, we encourage you to first look through the [issues](https://github.com/Starbem/react-native-starsystem/issues) and [pull requests](https://github.com/Starbem/react-native-starsystem/pulls) before filing a new issue.
...
- Fork the **react-native-starsystem** repo [here](https://github.com/Starbem/react-native-starsystem)
- `git clone <your-forked-repo-url> && cd react-native-starsystem`
- `yarn install`
- `yarn test`
